...
<body>
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved 
    ...
    <!-- Js Plugins -->
    <script src="templates/main/template/js/jquery-3.3.1.min.js"></script>
    <script src="templates/main/template/js/bootstrap.min.js"></script>
    <script src="templates/main/template/js/jquery.nice-select.min.js"></script>
    <script src="templates/main/template/js/jquery-ui.min.js"></script>
    <script src="templates/main/template/js/jquery.slicknav.js"></script>
    <script src="templates/main/template/js/mixitup.min.js"></script>
    <script src="templates/main/template/js/owl.carousel.min.js"></script>
    <script src="templates/main/template/js/main.js"></script>
